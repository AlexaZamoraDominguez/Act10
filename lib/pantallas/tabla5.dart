          ...
          child: ListView(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  border: OutlineInputBorder(),
                  hintText: 'ingrese su fecha de pedido',
                ),
              ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  border: OutlineInputBorder(),
                  hintText: 'ingrese la cantidad de articulos',
                ),
              ),
              const SizedBox(
                height: 10,
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  border: OutlineInputBorder(),
                  hintText: 'ingrese el precio del articulo',
                ),
              ),
              const SizedBox(
                height: 10,
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  border: OutlineInputBorder(),
                  hintText: 'ingrese el id Cliente',
                ),
              ),
              const SizedBox(
                height: 10,
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  border: OutlineInputBorder(),
                  hintText: 'ingrese el total de su compra',
                ),
              ),
              SizedBox(
                height: 10,
